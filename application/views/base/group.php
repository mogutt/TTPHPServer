        ...
        var Group = {
            ...
            addTpl : function(){
                var tpl =[
                    ...
                    '   <input type="text" class="form-control input-sm groupName" placeholder="群名称">',
            ...
            addMember : function(node,groupId){
            ...
            removeMember : function(node,groupId){
                $.post('/group/changeMember', {
                    groupId : groupId,
                    userId  : node.data('id'),
                    count   : $(".choosed_member .memberList li").length-0-1,
