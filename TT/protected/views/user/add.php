...
<form role="form" method="post" enctype="multipart/form-data" class="formclass" id="signupForm">
    ...
    <div class="form-group">
        <label for="exampleInputPassword1">花名<span class="import">*</span></label>
    ...
    <div class="form-group">
        <label for="exampleInputPassword1">密码<span class="import">*</span></label>
    ...
    <div class="form-group">
        <label for="exampleInputPassword1">部门<span class="import">*</span></label>
    ...
    <div class="form-group">
        <label for="exampleInputPassword1">手机号码<span class="import">*</span></label>
    ...
    <div class="form-group">
        <label for="exampleInputPassword1">邮箱<span class="import">*</span></label>
    ...
    <div class="form-group">
        <label for="exampleInputPassword1">性别<span class="import">*</span></label>
        <div class="radio">
        <label>
    ...
    <div class="form-group">
        <label for="exampleInputPassword1">地址<span class="import">*</span></label>
    ...
    <div class="form-group">
        <label for="exampleInputPassword1">工号<span class="import">*</span></label>
    ...
    <div class="form-group">
        <label for="exampleInputPassword1">状态<span class="import">*</span></label>
        <div class="radio">
            <label>
